...
yes=Tak
no=Nie
confirm-delete=Czy jesteś pewien, że chcesz usunąć { $app_title }?
cancel=Anuluj
...
# home_screen.rs
installed-header=Posiadasz { $number } zainstalowanych Web Appek:
...
sound-and-video=Dźwięk i Wideo
